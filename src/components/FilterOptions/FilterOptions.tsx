...
const FilterOptions: React.FC<FilterComponentProps> = ({ onFilterChange }) => {

    const t = useTranslations('filterComponent')

    const [filters, setFilters] = useState<FilterState>({
        binoTuri: 'Kommercheski',
        locatsiya: '',
        xonalarSoni: '1',
        narxFrom: 0,
        narxTo: 100,
    ...
    return (
        <section className='container mx-auto max-tablet:w-full w-[80%] h-[184px] py-[15px] px-[25px] rounded-md shadow-[0_3px_20px_0_rgba(56,137,242,0.3)] bg-white'>
            <div>
                <div className="grid grid-cols-4 md:grid-cols-5 gap-[20px] max-[1200px]:gap-[10px]">
                    <div>
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700">Xonalar soni</label>
                        <div className="mt-1 flex gap-[5px] border-[1px] rounded-md p-[4px] border-gray-300 max-tablet:overflow-auto">
                            {['1', '2', '3', '4+'].map((num) => (
                                <>
                                    <button
                                        key={num}
                                        onClick={() => handleInputChange({ target: { name: 'xonalarSoni', value: num } } as React.ChangeEvent<HTMLInputElement>)}
                                    ...
                                    {/* <span className='inline-block w-[1px] h-[] bg-slate-400'></span> */}
                                </>
                            ))}
                        </div>
                    </div>
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700">Maydoni</label>
