...
const FilterOptions: React.FC<FilterComponentProps> = ({ onFilterChange }) => {
    ...
    return (
        <section className='container mx-auto max-tablet-m:hidden max-tablet:w-full w-[80%] h-[184px] py-[15px] px-[25px] rounded-md shadow-[0_3px_20px_0_rgba(56,137,242,0.3)] bg-white'>
            <div>
            ...
            <div className='flex items-center justify-between'>
                <div className='flex items-center gap-[15px]'>
                    <button className='flex items-center justify-center w-[35px] h-[35px] bg-[rgba(56,137,242,0.25)] hover rounded-sm' onClick={openModal}>
                ...
                <div className='flex gap-[15px]'>
                    <a href="#" className='flex group items-center relative gap-[10px] px-[30px] py-[10px] border-[1px] border-blue_10 text-black rounded-md hover'>{t('searchByMap')}
                        <span>
                            <Image className='absolute top-[-5px] right-[35px] animate-bounce-slow group-hover:animate-none' src={MapLocationImg} alt="map-img" width={25} height={38} unoptimized />
                            <Image src={MapImg} alt="map-img" width={45} height={35} unoptimized />
                        </span>
                    </a>
                    <button className='px-[80px] py-[10px] bg-blue_10 text-white rounded-md hover'>{t('search')}</button>
                </div>
            </div>
